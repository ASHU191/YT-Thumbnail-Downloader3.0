...
export default function ProfilePictureDownloaderPage() {
  ...
  const currentLang = (langParam as Language) || "en"
  const router = useRouter()

  useEffect(() => {
    // Redirect to English version by default
    if (currentLang !== "en") {
      router.replace("/youtube-profile-picture-downloader/en")
    }
  }, [router, currentLang])
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
      <NavigationStripe currentLang={currentLang} currentTool="profile" />
